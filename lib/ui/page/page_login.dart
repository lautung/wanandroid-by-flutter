...
import 'package:wanandroid_flutter/ui/page/page_register.dart';
  ...
  void _doLogin() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (result['errorCode'] == -1) {
        Fluttertoast.showToast(msg: result['errorMsg'],toastLength:Toast.LENGTH_LONG,gravity: ToastGravity.CENTER);
      } else {
